...
class ModelEvaluation:
    def __init__(self):
        ...
        self.TRAIN_CONFIG=CONFIG.model_training
        self.EVAL_CONFIG=CONFIG.model_evaluation
    ...
    def evaluate_on_val_data(self,model,val_data:pd.DataFrame)->None:
        ...
        x_val_numerical_encoded=val_data[['digit_cnt','is_https']]
